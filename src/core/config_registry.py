...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SCHEDULE_TRADING_DAY_ONLY": {
        "title": "Trading Day Only",
        "description": "Run scheduled tasks only on A-share trading days.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "LOG_RETENTION_DAYS": {
        ...
        "description": "Days to keep regular log files.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "LOG_DEBUG_RETENTION_DAYS": {
        "title": "Debug Log Retention Days",
        "description": "Days to keep debug log files.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
